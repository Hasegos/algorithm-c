...
1. 문제 주소 : `https://www.acmicpc.net/problem/2884`
2. [문제 시작](#문제)
3. [해결방안](#해결방안)
4. [조건문 목차 돌아가기](../README.md)
___

### [해당 코드](./BOJ_2884_알람시계.c)
...
## 해결방안
**1. 입력된 분($M$)에서 45를 뺐을 때 음수가 된다면 시간($H$)을 1 감소시키고 분에 60을 더하며, 시간이 0 미만이 될 경우 23으로 재설정하는 예외 처리가 필요하다.**
