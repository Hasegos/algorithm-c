...
1. 문제 주소 : `https://www.acmicpc.net/problem/2525`
2. [문제 시작](#문제)
3. [해결방안](#해결방안)
4. [입출력과 사칙연산 목차 돌아가기](../README.md)
___

### [해당 코드](./BOJ_2525_오븐시계.c)
...
## 해결방안
**1. 현재 시각에 요리 시간을 더한 총 분(Total Minutes)을 계산한 뒤, 이를 다시 24시간 형식으로 변환하기 위해 나누기(`/`)와 나머지(`%`) 연산자를 활용한다.**
