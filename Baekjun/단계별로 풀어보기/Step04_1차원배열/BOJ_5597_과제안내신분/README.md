...
1. 문제 주소 : `https://www.acmicpc.net/problem/5597`
2. [문제 시작](#문제)
3. [해결방안](#해결방안)
4. [1차원 배열 목차 돌아가기](../README.md)
___

### [해당 코드](./BOJ_5597_과제안내신분.c)
...
## 해결방안
**1. 크기가 31인 체크용 배열(Boolean)을 만들어 제출자의 번호에 해당하는 인덱스를 `true`로 바꾼 뒤, 배열을 1부터 순회하며 `false`로 남은 번호 두 개를 찾아 출력한다.**
